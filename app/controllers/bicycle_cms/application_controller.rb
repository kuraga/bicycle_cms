    ...
    protected
      ...
      before_filter do
        self.class.before_render_filter do
          set_resource_ivar(begin; get_resource_ivar.decorate; rescue NameError; get_resource_ivar; end) if respond_to?(:get_resource_ivar, true)
          set_collection_ivar(begin; get_collection_ivar.decorate; rescue NameError; get_collection_ivar; end) if respond_to?(:get_collection_ivar, true)
        end
      end
    ...
    protected
      ...
      def self.inherited(subclass)
        ...
        subclass.class_eval do
          ...
          def as_role
            { :as => current_user_role(object: (params[:id] ? resource : nil)) || self.resources_configuration[:self][:role] || :default }
          end
